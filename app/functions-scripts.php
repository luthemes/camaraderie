...
add_action(
	...
	function() {
		 ...
		 */
		wp_enqueue_style( 'camaraderie-screen', get_theme_file_uri( 'public/css/screen.css' ), array(), '1.0.0' );

		/**
		 * We will be enqueue the app.js file, which mainly be for the navigation only.
		 */
		wp_enqueue_script( 'camaraderie-app', get_theme_file_uri( 'public/js/app.js' ), array('jquery'), '1.0.0', true );
