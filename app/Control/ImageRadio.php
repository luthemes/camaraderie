...
class ImageRadio extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'backdrop-image-radio-css', get_theme_file_uri( 'public/css/image-radio.css' ), array(), $this::$version );
		wp_enqueue_script( 'backdrop-image-radio-js', get_theme_file_uri( 'public/js/image-radio.js' ), array( 'jquery' ), $this::$version, true );
	}
