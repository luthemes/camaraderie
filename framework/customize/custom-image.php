...
============================================================================================================================
The customizer.php gives the user the ability to change features within the customizer. This has been setup to allow users to
set different layouts within the theme and other features that the WordPress functionality is included.
...
Table of Content
============================================================================================================================
 1.0 - Custom Image (Header)
 2.0 - Cutom Image (Validation)
============================================================================================================================
*/
/*
============================================================================================================================
...
function camaraderie_customize_register_setup($wp_customize) { 
    ...
    $wp_customize->add_setting('custom_image', array(
        'default'   => get_theme_file_uri('/framework/assets/images/custom-image.jpg'),
    ...
    $wp_customize->add_setting('custom_avatar', array(
        'default'   => get_theme_file_uri('/framework/assets/images/avatar.jpg'),
        'sanitize_callback' => 'esc_url_raw',
    ));
